...
namespace WebApiWithDI.Controllers
{
    ...
    {
        private readonly SqlServerTodoContext _context;

        public TodoItemSqlServersController(SqlServerTodoContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.TodoItemSqlServer.ToListAsync();
        }
